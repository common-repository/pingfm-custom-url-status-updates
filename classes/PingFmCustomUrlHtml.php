      ...
      <div class="postbox">
        ...
        <div class="inside">
          ...
          <p>
            <label>
                <input type="radio"
                name="pingfm_options[image_size]"
                id="pingfm_image_size_thumbnail"
                value="thumbnail"
                <?php echo ('thumbnail' == $options->image_size) ? 'checked="checked"' : ''; ?> />
                Thumbnail
            </label>
            &#160;&#160;
            <label>
                <input type="radio"
                name="pingfm_options[image_size]"
                id="pingfm_image_size_medium"
                value="medium"
                <?php echo ('medium' == $options->image_size) ? 'checked="checked"' : ''; ?> />
                Medium
            </label>
            &#160;&#160;
            <label>
                <input type="radio"
                name="pingfm_options[image_size]"
                id="pingfm_image_size_large"
                value="large"
                <?php echo ('large' == $options->image_size) ? 'checked="checked"' : ''; ?> />
                Large
            </label>
            &#160;&#160;
            <label>
                <input type="radio"
                name="pingfm_options[image_size]"
                id="pingfm_image_size_original"
                value="original"
                <?php echo ('original' == $options->image_size) ? 'checked="checked"' : ''; ?> />
                Original
            </label>
          </p>
