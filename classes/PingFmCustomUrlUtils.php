...
class PingFmCustomUrlOptions implements PingFmCustomUrlConstants {
     ...
     */
    public static function factory($fresh = false) {
        $c = __CLASS__;
...
class PingFmCustomUrlUtils implements PingFmCustomUrlConstants {
    ...
    public static function insert_ping($ping) {
        ...
        self::log_error("Contents of \$ping parameter:\n" . print_r($ping, true));
        self::log_error("PingFmCustomUrlOptions:\n" . print_r($options, true));
        self::log_error("Arguments to wp_insert_post():\n" . print_r($args, true));

        $post_id = wp_insert_post($args);

        self::log_error("post_id value of new post: $post_id");
        ...
        if ($options->inline_images && !empty($ping['media'])) {
            ...
            if (!is_wp_error($media_html)) {
                ...
                if ($attachments) {
                    ...
                    $media_html = wp_get_attachment_image($image->ID, 'medium');
                }
